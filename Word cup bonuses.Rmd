...
world_cup_bonuses <- ggplot(bonuses2, aes(x = number, y = cumulative)) +
  ...
  labs(x = "Stage",
       ...
       subtitle = "Data from The Guardian") +
  
  # add labels to x and y axis, title. I put the source info in the subtitle
  # because the caption kept getting cropped off when I loaded the image in 
  # shiny

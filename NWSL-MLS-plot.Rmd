...
plot5 <- min_or_max_data %>%
  ...
  geom_ribbon(aes(x = season, ymin = min_salary, ymax = max_salary), alpha = 0.05, fill = "black") +
...
file_copy("graphics/plot5.png", new_path = "State-of-womens-soccer/www/plot5.png", overwrite = TRUE)
